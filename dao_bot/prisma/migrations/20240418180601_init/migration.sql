...
-- CreateIndex
CREATE INDEX "balance_ledger_user_id_from_idx" ON "balance_ledger"("user_id_from");

-- CreateIndex
CREATE INDEX "balance_ledger_user_id_to_idx" ON "balance_ledger"("user_id_to");

-- CreateIndex
CREATE INDEX "balance_ledger_user_id_from_user_id_to_idx" ON "balance_ledger"("user_id_from", "user_id_to");

-- CreateIndex
CREATE INDEX "balance_ledger_user_id_to_user_id_from_idx" ON "balance_ledger"("user_id_to", "user_id_from");
...
-- AddForeignKey
ALTER TABLE "balance_ledger" ADD CONSTRAINT "balance_ledger_user_id_from_fkey" FOREIGN KEY ("user_id_from") REFERENCES "user"("id") ON DELETE RESTRICT ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "balance_ledger" ADD CONSTRAINT "balance_ledger_user_id_to_fkey" FOREIGN KEY ("user_id_to") REFERENCES "user"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
